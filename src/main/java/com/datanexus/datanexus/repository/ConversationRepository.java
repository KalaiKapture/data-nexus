...
public class ConversationRepository {
    ...
    public List<Conversation> findByUserIdOrdered(String userId, String orderDir, int limit, int offset) {
    ...
    public Conversation findByIdAndUserId(String id, String userId) {
